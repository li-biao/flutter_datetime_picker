...
class CommonPickerModel extends BasePickerModel {
  ...
  bool isShowRightList;

  LocaleType locale;

  CommonPickerModel({this.currentTime, locale, this.isShowRightList = true}) : this.locale = locale ?? LocaleType.en;
...
class DatePickerModel extends CommonPickerModel {
  ...
  DatePickerModel({DateTime currentTime, DateTime maxTime, DateTime minTime, LocaleType locale, bool isShowRightList}) : super(locale: locale, isShowRightList: isShowRightList) {
